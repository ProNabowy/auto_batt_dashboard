...
export default function TeamViews({ isDisapled, data }) {
        ...
        <section>
            ...
            <div className='border border-[#B70B28] bg-white py-8 rounded-[5px]'>
                ...
                <div className='my-10 px-8'>
                    ...
                    <IdentityInputBox isDisapled={isDisapled} data={{ labelsName: ['First Name', 'Last Name'], defaultValue: ['John', 'Doe'] }} />

                    <IdentityInputBox isDisapled={isDisapled} data={{ labelsName: ['Email', 'Phone Number'], defaultValue: ['john.doe@gmail.com', '+020 674 758 7365'] }} />
                ...
                <div className='flex items-center justify-end mt-10 px-8'>
                    ...
                    <Link to={data?.type === "view" ? "/teams/teams-edit" : ""}>
