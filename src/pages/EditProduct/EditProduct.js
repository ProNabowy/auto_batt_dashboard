            ...
            <div className='col-span-9'>
                ...
                <div className='bg-white border border-[#8B6464] p-5 rounded-[6px]'>
                    ...
                    <div className='mb-5'>
                        ...
                        <input type='text' defaultValue={data.type !== "add" ? 'premium - mtx-49/h8' : null} className='font-medium w-full text-[20px] border border-[#8f7b7b] p-2 capitalize text-black rounded-[5px]' />
                    ...
                    <div className='mb-5'>
                        ...
                        <input type='text' className='font-medium w-full border border-[#8f7b7b] p-2 capitalize text-[14px] text-black rounded-[5px]' defaultValue={data.type !== "add" ? 'Velit aut placeat veniam hic. Eaque impedit cum explicabo tempora corporis aspernatur quibusdam exercitationem. Deserunt saepe quis ad non nihil error. Est dignissimos dolorum quas suscipit quam eos cumque.' : null} />
                    ...
                    <div className='mb-5 flex items-center justify-between'>
                        ...
                        <div className='flex-1 me-6'>
                            ...
                            <input type='text' className='font-medium w-full text-[11px] border border-[#8f7b7b] p-2 capitalize text-black rounded-[5px]' defaultValue={data.type !== "add" ? 125 : null} />
                        ...
                        <div className='flex-1 me-6'>
                            ...
                            <input type='text' className='font-medium w-full text-[11px] border border-[#8f7b7b] p-2 capitalize text-black rounded-[5px]' defaultValue={data.type !== "add" ? 16 : null} />
                        ...
                        <div className='flex-1 me-6'>
                            ...
                            <input type='text' className='font-medium w-full text-[11px] border border-[#8f7b7b] p-2 capitalize text-black rounded-[5px]' defaultValue={data.type !== "add" ? 800 : null} />
                        ...
                        <div className='flex-1 me-6'>
                            ...
                            <input type='text' className='font-medium text-[11px] w-full border border-[#8f7b7b] p-2 capitalize text-black rounded-[5px]' defaultValue={data.type !== "add" ? 800 : null} />
                    ...
                    <div className='mb-5 flex items-center justify-between'>
                        ...
                        <div className='flex-1 me-6'>
                            ...
                            <input type='text' className='font-medium w-full text-[11px] border border-[#8f7b7b] p-2 capitalize text-black rounded-[5px]' defaultValue={data.type !== "add" ? 'dry' : null} />
                        ...
                        <div className='flex-1 me-6'>
                            ...
                            <input type='text' className='font-medium w-full text-[11px] border border-[#8f7b7b] p-2 capitalize text-black rounded-[5px]' defaultValue={data.type !== "add" ? '12' : null} />
                        ...
                        <div className='flex-1 me-6'>
                            ...
                            <input type='text' className='font-medium w-full text-[11px] border border-[#8f7b7b] p-2 capitalize text-black rounded-[5px]' defaultValue={data.type !== "add" ? 'Top' : null} />
                    ...
                    <div className='mb-5 flex items-center justify-between'>
                        ...
                        <div className='flex-1 me-6'>
                            ...
                            <input type='text' className='font-medium w-full text-[11px] border border-[#8f7b7b] p-2 capitalize text-black rounded-[5px]' defaultValue={data.type !== "add" ? '350 EGP' : null} />
                        ...
                        <div className='flex-1 me-6'>
                            ...
                            <input type='text' className='font-medium w-full text-[11px] border border-[#8f7b7b] p-2 capitalize text-black rounded-[5px]' defaultValue={data.type !== "add" ? '6.6 * 7 13/16 * 6 3/4 * 10 13/16' : null} />
                        ...
                        <div className='flex-1 me-6'>
                            ...
                            <input type='text' className='font-medium w-full text-[11px] border border-[#8f7b7b] p-2 capitalize text-black rounded-[5px]' defaultValue={data.type !== "add" ? 'Moura' : null} />
                        ...
                        <div className='flex-1 me-6'>
                            ...
                            <input type='text' className='font-medium w-full text-[11px] border border-[#8f7b7b] p-2 capitalize text-black rounded-[5px]' defaultValue={data.type !== "add" ? 'battery category' : null} />
