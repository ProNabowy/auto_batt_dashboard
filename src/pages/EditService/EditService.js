        ...
        <section className='grid grid-cols-12 gap-3'>
            ...
            <div className='col-span-8 relative bg-white rounded-[10px] shadow p-5'>
                ...
                <div className='mb-8'>
                    ...
                    <input type='text' defaultValue={data.type === "add" ? "" : 'BMS battery coding'} className='p-2 border border-[#8B6464] rounded-[5px] w-full' />
                ...
                <div className='mb-8'>
                    ...
                    <textarea rows={7} defaultValue={data.type === "add" ? "" : description} className='p-2 border border-[#8B6464] rounded-[5px] w-full' />
