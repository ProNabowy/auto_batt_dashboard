...
export default function BreadcrumbNav() {
    ...
    return (
        <div className="flex h-[72px] mb-6">
                    ...
                    {improvePathname.map((path, index) => {
                        ...
                        return path.length ? (
                            ...
                            <Fragment key={index}>
                                ...
                                <Link Link to={path === (improvePathname[improvePathname.length - 1]) ? window.location.path : "/" + path} className="text-[#8B6464] inline-block capitalize text-[15px]">
